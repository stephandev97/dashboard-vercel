...
function cookieSerialize(t2, s2, i2) {
  ...
  if (n2.expires) {
    if (!(/* @__PURE__ */ __name(function isDate(e2) {
      return "[object Date]" === Object.prototype.toString.call(e2) || e2 instanceof Date;
    }, "isDate"))(n2.expires) || isNaN(n2.expires.valueOf())) throw new TypeError("option expires is invalid");
...
var RealtimeService = class extends BaseService {
  ...
  async subscribe(e2, t2, s2) {
    ...
    const listener = /* @__PURE__ */ __name(function(e3) {
      const s3 = e3;
      let i3;
      try {
...
var CrudService = class extends BaseService {
  ...
  _getFullList(e2 = 500, t2) {
    ...
    let s2 = [], request = /* @__PURE__ */ __name(async (i2) => this.getList(i2, e2 || 500, t2).then(((e3) => {
      const t3 = e3.items;
...
var RecordService = class extends CrudService {
  ...
  async authWithPassword(e2, t2, s2) {
    ...
    return n2 = this.authResponse(n2), i2 && this.isSuperusers && (/* @__PURE__ */ __name(function registerAutoRefresh(e3, t3, s3, i3) {
      resetAutoRefresh(e3);
    ...
    }, "registerAutoRefresh"))(this.client, i2, (() => this.authRefresh({ autoRefresh: true })), (() => this.authWithPassword(e2, t2, Object.assign({ autoRefresh: true }, s2)))), n2;
  }
...
var SubBatchService = class {
  ...
  prepareRequest(e2, t2) {
    ...
    let s2 = t2.body;
    isFormData(s2) && (s2 = (/* @__PURE__ */ __name(function convertFormDataToObject(e3) {
      let t3 = {};
...
var Client = class {
  ...
  initSendOptions(e2, t2) {
    if ((t2 = Object.assign({ method: "GET" }, t2)).body = (/* @__PURE__ */ __name(function convertToFormDataIfNeeded(e3) {
...
async function onRequestGet({ request, env }) {
  try {
    ...
    const safe = /* @__PURE__ */ __name((v) => v && typeof v === "object" && !Array.isArray(v) ? { ...v } : {}, "safe");
    const asNumber = /* @__PURE__ */ __name((v) => Number.isFinite(Number(v)) ? Number(v) : 0, "asNumber");
    return new Response(
      JSON.stringify({
        day: dailyRecord.day,
...
// ../.wrangler/tmp/pages-QmpckU/functionsRoutes-0.24570849839261155.mjs
var routes = [
  {
    routePath: "/api/daily",
    mountPath: "/api",
...
// ../../../Users/sefer/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i2 = 0;
  while (i2 < str.length) {
...
// ../../../Users/sefer/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../.wrangler/tmp/bundle-bo4Hdz/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-bo4Hdz/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.025979288235438935.mjs.map

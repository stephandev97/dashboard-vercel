...
// .wrangler/tmp/pages-QmpckU/functionsWorker-0.025979288235438935.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var ClientResponseError = class _ClientResponseError extends Error {
  static {
    __name(this, "_ClientResponseError");
  }
  static {
    __name2(this, "ClientResponseError");
  }
  constructor(e2) {
...
__name(cookieParse, "cookieParse");
__name2(cookieParse, "cookieParse");
function cookieSerialize(t2, s2, i2) {
  ...
  if (n2.expires) {
    if (!(/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function isDate(e2) {
      return "[object Date]" === Object.prototype.toString.call(e2) || e2 instanceof Date;
    }, "isDate"), "isDate"))(n2.expires) || isNaN(n2.expires.valueOf())) throw new TypeError("option expires is invalid");
...
__name2(getTokenPayload, "getTokenPayload");
...
__name2(isTokenExpired, "isTokenExpired");
...
var BaseAuthStore = class {
  static {
    __name(this, "BaseAuthStore");
  }
  static {
    __name2(this, "BaseAuthStore");
  }
  constructor() {
...
var LocalAuthStore = class extends BaseAuthStore {
  static {
    __name(this, "LocalAuthStore");
  }
  static {
    __name2(this, "LocalAuthStore");
  }
...
__name(normalizeUnknownQueryParams, "normalizeUnknownQueryParams");
__name2(normalizeUnknownQueryParams, "normalizeUnknownQueryParams");
...
__name2(serializeQueryParams, "serializeQueryParams");
...
__name(prepareQueryParamValue, "prepareQueryParamValue");
__name2(prepareQueryParamValue, "prepareQueryParamValue");
var RealtimeService = class extends BaseService {
  static {
    __name(this, "RealtimeService");
  }
  static {
    __name2(this, "RealtimeService");
  }
  constructor() {
  ...
  async subscribe(e2, t2, s2) {
    ...
    const listener = /* @__PURE__ */ __name2(function(e3) {
      const s3 = e3;
      let i3;
      try {
...
var CrudService = class extends BaseService {
  static {
    __name(this, "CrudService");
  }
  static {
    __name2(this, "CrudService");
  }
  decode(e2) {
    return e2;
  }
  ...
  _getFullList(e2 = 500, t2) {
    ...
    let s2 = [], request = /* @__PURE__ */ __name2(async (i2) => this.getList(i2, e2 || 500, t2).then(((e3) => {
      const t3 = e3.items;
...
__name(normalizeLegacyOptionsArgs, "normalizeLegacyOptionsArgs");
__name2(normalizeLegacyOptionsArgs, "normalizeLegacyOptionsArgs");
function resetAutoRefresh(e2) {
  e2._resetAutoRefresh?.();
}
__name(resetAutoRefresh, "resetAutoRefresh");
__name2(resetAutoRefresh, "resetAutoRefresh");
var RecordService = class extends CrudService {
  static {
    __name(this, "RecordService");
  }
  static {
    __name2(this, "RecordService");
  }
  constructor(e2, t2) {
  ...
  async authWithPassword(e2, t2, s2) {
    ...
    return n2 = this.authResponse(n2), i2 && this.isSuperusers && (/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function registerAutoRefresh(e3, t3, s3, i3) {
      resetAutoRefresh(e3);
    ...
    }, "registerAutoRefresh"), "registerAutoRefresh"))(this.client, i2, (() => this.authRefresh({ autoRefresh: true })), (() => this.authWithPassword(e2, t2, Object.assign({ autoRefresh: true }, s2)))), n2;
  }
...
__name(openBrowserPopup, "openBrowserPopup");
__name2(openBrowserPopup, "openBrowserPopup");
var CollectionService = class extends CrudService {
  static {
    __name(this, "CollectionService");
  }
  static {
    __name2(this, "CollectionService");
  }
  get baseCrudPath() {
...
var CronService = class extends BaseService {
  static {
    __name(this, "CronService");
  }
  static {
    __name2(this, "CronService");
  }
  async getFullList(e2) {
...
__name(hasFileField, "hasFileField");
__name2(hasFileField, "hasFileField");
var r = /^[\-\.\d]+$/;
...
__name(inferFormDataValue, "inferFormDataValue");
__name2(inferFormDataValue, "inferFormDataValue");
var BatchService = class extends BaseService {
  static {
    __name(this, "BatchService");
  }
  static {
    __name2(this, "BatchService");
  }
  constructor() {
...
var SubBatchService = class {
  static {
    __name(this, "SubBatchService");
  }
  static {
    __name2(this, "SubBatchService");
  }
  constructor(e2, t2) {
  ...
  prepareRequest(e2, t2) {
    ...
    let s2 = t2.body;
    isFormData(s2) && (s2 = (/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function convertFormDataToObject(e3) {
      let t3 = {};
    ...
    }, "convertFormDataToObject"), "convertFormDataToObject"))(s2));
    for (const t3 in s2) {
      const i2 = s2[t3];
...
var Client = class {
  ...
  initSendOptions(e2, t2) {
    if ((t2 = Object.assign({ method: "GET" }, t2)).body = (/* @__PURE__ */ __name2(/* @__PURE__ */ __name(function convertToFormDataIfNeeded(e3) {
...
var PB_URL = "https://railway-production-857d.up.railway.app";
var pb = new Client(PB_URL);
pb.autoCancellation(false);
async function getDailyStatRecordSmart({ dateKey, pb: pb2 }) {
  try {
    return await pb2.collection("daily_stats").getFirstListItem(`day="${dateKey}"`);
  } catch (e2) {
    if (e2?.status === 404) return null;
    throw e2;
  }
}
__name(getDailyStatRecordSmart, "getDailyStatRecordSmart");
__name2(getDailyStatRecordSmart, "getDailyStatRecordSmart");
async function onRequestGet({ request, env }) {
  try {
    const url = new URL(request.url);
    const dateKey = url.searchParams.get("day") || (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
    const pb2 = new Client(env.PB_URL);
    pb2.autoCancellation(false);
    let dailyRecord = null;
    try {
      dailyRecord = await getDailyStatRecordSmart({ dateKey, pb: pb2 });
    } catch {
      dailyRecord = null;
    }
    if (!dailyRecord) {
    ...
    try {
      ...
      orders_detail = await pb2.collection("orders").getFullList({ filter, sort: "-created" });
    } catch (err) {
    }
    const safe = /* @__PURE__ */ __name2((v) => v && typeof v === "object" && !Array.isArray(v) ? { ...v } : {}, "safe");
    const asNumber = /* @__PURE__ */ __name2((v) => Number.isFinite(Number(v)) ? Number(v) : 0, "asNumber");
    return new Response(
      JSON.stringify({
        day: dailyRecord.day,
...
async function onRequestGet2({ request, env }) {
  try {
    ...
    for (let i2 = days - 1; i2 >= 0; i2--) {
      ...
      dt.setDate(end.getDate() - i2);
      const key = formatDay(dt);
      try {
        const rec = await getDailyStatRecordSmart({ dateKey: key, pb: pb2 });
        out.push({
          day: key,
    ...
    return new Response(JSON.stringify({ error: e2?.message ?? String(e2) }), {
      status: 500,
      headers: { "content-type": "application/json; charset=utf-8" }
    });
  }
...
// ../../Users/sefer/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../Users/sefer/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-IyMiPc/middleware-insertion-facade.js
...
// ../../Users/sefer/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-IyMiPc/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.025979288235438935.js.map
